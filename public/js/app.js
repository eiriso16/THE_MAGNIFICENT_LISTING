    ...
    if(data){
      ...
      for(let i in data){
        ...
        deadline.id = data[i].name;
          if(data[i].duedate){
            deadline.title = data[i].duedate.substring(0,10);  
          }
...
//---------create on click dropdown---------------

/*let dropdown = document.createElement("button");
  dropdown.onclick = tagDrop();
  dropdown.classList.add = "dropMenu"; 
  dropdown.innerHTML = "Tags";
  
  let menuItems = document.createElement("div");
  menuItems.id = "dropTags";
  menuItems.classList.add = "dropTags";
